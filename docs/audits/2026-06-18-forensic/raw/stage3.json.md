# stage3.json (verbatim)

> Raw audit artifact, wrapped in Markdown for fast-track-eligible tracking. Content below is byte-for-byte the original `stage3.json`. To extract: delete this header and the surrounding fence lines.
